            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_PROFIL); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->NAMA_TOKO,base_url().$this->uri->segment(1)."/delete/".$showData->ID_PROFIL); 
						?>	
					</td>
