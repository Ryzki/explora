				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="input" class="form-control required" id="NAMA_TOKO" name="NAMA_TOKO" >
							</div>
						</div>	
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">No Telp Toko :</label>
							<div class="col-sm-2">
								<input type="input" class="form-control required number" id="TELP_TOKO" name="TELP_TOKO" >
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Website :</label>
							<div class="col-sm-5">
								<input type="input" class="form-control required" id="WEBSITE" name="WEBSITE" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<textarea type="input" class="form-control required" id="ALAMAT_TOKO" name="ALAMAT_TOKO" ></textarea>
							</div>
						</div>
							<hr>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="input" class="form-control required email" id="EMAIL_FROM" name="EMAIL_FROM">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="input" class="form-control required" id="PASS_EMAIL_FROM" name="PASS_EMAIL_FROM" >
								<sub>Untuk proses kirim laporan</sub>
							</div>
						</div>
						<hr>
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="input" class="form-control required email" id="EMAIL_OWNER" name="EMAIL_OWNER" >
								<sub>Untuk proses kirim laporan</sub>
							</div>
						</div>
