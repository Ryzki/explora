			...
			<div class="box">		
				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
							...
							<div class="col-sm-4">
								<input type="input" class="form-control required number" id="MIN_MENIT" name="MIN_MENIT" >
							</div>
						</div>	
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Maksimal Menit :</label>
							<div class="col-sm-4">
								<input type="input" class="form-control required number" id="MAX_MENIT" name="MAX_MENIT" >
							</div>
						</div>	
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Harga Jasa Grafis :</label>
							<div class="col-sm-4">
								<input type="input" class="form-control required number" id="HARGA" name="HARGA">
							</div>
						</div>		
						<div class="form-group">
