					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='harga') echo "selected"; ?> value="harga">Berdasarkan Harga</option>
							</select>
						</div>
						<div class="col-sm-6">							
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_HARGA_GRAFIS); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->HARGA,base_url().$this->uri->segment(1)."/delete/".$showData->ID_HARGA_GRAFIS); 
						?>	
					</td>
					<td align="center"><?php echo $no; ?>.</td>
					<td ><?php echo $showData->MIN_MENIT; ?></td>
					<td ><?php echo $showData->MAX_MENIT; ?></td>
					<td ><?php echo format_rupiah($showData->HARGA); ?></td>
				</tr>
				<?php
				$no++;
				}
