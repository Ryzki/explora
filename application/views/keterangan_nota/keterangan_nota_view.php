					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='keterangan') echo "selected"; ?> value="keterangan">Berdasarkan Keterangan</option>
							</select>
						</div>
						<div class="col-sm-6">							
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_KETERANGAN); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->KETERANGAN,base_url().$this->uri->segment(1)."/delete/".$showData->ID_KETERANGAN); 
						?>	
					</td>
