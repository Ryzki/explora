			...
			<div class="box">		
				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Jumlah Barang Keluar :</label>
							<div class="col-sm-2">
								<input type="input" class="form-control required number"   name="JUMLAH_KELUAR" >
							</div>
						</div>
						
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Tanggal Barang Keluar :</label>
							<div class="col-sm-2">
								<input type="input" class="form-control required" id="datepicker"  name="TGL_BARANG_KELUAR" data-date-format='dd-mm-yyyy'>
							</div>
						</div>
