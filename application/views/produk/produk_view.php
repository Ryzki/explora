					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='nama_produk ') echo "selected"; ?> value="nama_produk ">Berdasarkan Nama Produk</option>
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->id_produk); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->nama_produk,base_url().$this->uri->segment(1)."/delete/".$showData->id_produk); 
						?>	
					</td>
					...
					<td >
					<?php 
					if($showData->kategori == '1'){
						echo "A3+";
					}
					if($showData->kategori == '2'){
						echo "Indoor/Outdoor";
					}
					if($showData->kategori == '3'){
						echo "Lain-Lain";
					}
					...
					<td ><?php echo $showData->NAMA_TOKO ; ?></td>
				</tr>
				<?php
				$no++;
				}
