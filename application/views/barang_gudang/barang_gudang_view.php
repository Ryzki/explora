					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='nama_barang_gudang') echo "selected"; ?> value="nama_barang_gudang">Berdasarkan Nama barang</option>
							</select>
						</div>
						<div class="col-sm-6">							
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_BARANG_GUDANG); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->NAMA_BARANG_GUDANG,base_url().$this->uri->segment(1)."/delete/".$showData->ID_BARANG_GUDANG); 
						?>	
					</td>
					<td align="center"><?php echo $no; ?>.</td>
					<td ><?php echo $showData->NAMA_BARANG_GUDANG; ?></td>
					<td ><?php echo $showData->STOK; ?></td>
					<td ><?php echo $showData->SATUAN_BARANG_GUDANG; ?></td>
