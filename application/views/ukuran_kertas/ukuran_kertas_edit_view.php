			...
			<div class="box">		
				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
						<input type="hidden" name="ID_UKURAN_KERTAS" value="<?php echo $this->oldData->ID_UKURAN_KERTAS; ?>">
						
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Nama Kertas :</label>
							<div class="col-sm-4">
								<input type="input" class="form-control required" id="UKURAN_KERTAS" name="UKURAN_KERTAS" value="<?php echo $this->oldData->UKURAN_KERTAS; ?>">
							</div>
						</div>	
						<div class="form-group">
