					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='produk_lain ') echo "selected"; ?> value="produk_lain ">Berdasarkan Nama Produk</option>
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_PRODUK_LAIN); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->PRODUK_LAIN,base_url().$this->uri->segment(1)."/delete/".$showData->ID_PRODUK_LAIN); 
						?>	
					</td>
					<td align="center"><?php echo $no; ?>.</td>
					<td ><?php echo $showData->PRODUK_LAIN ; ?></td>
					</td>
				</tr>
				<?php
				$no++;
