				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="input" class="form-control required" id="NAMA_KERTAS" name="NAMA_KERTAS" >
							</div>
						</div>	
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Harga Kertas :</label>
							<div class="col-sm-2">
								<input type="input" class="form-control required number" id="HARGA_KERTAS" name="HARGA_KERTAS" >
							</div>
						</div>	
						<div class="form-group">
