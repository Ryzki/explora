					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='NAMA_KERTAS ') echo "selected"; ?> value="NAMA_KERTAS ">Berdasarkan Kertas Bahan</option>
        ...
        <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th width="65%">Nama Kertas Bahan</th>
                <th width="35%">Harga Kertas Bahan</th>
              </tr>
            </thead>
            <tbody>
				<?php
			...
			function format_rupiah($angka){
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_KERTAS); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->NAMA_KERTAS,base_url().$this->uri->segment(1)."/delete/".$showData->ID_KERTAS); 
						?>	
					</td>
					<td align="center"><?php echo $no; ?>.</td>
					<td ><?php echo $showData->NAMA_KERTAS ; ?></td>
					<td ><?php echo  format_rupiah($showData->HARGA_KERTAS) ; ?></td>
				</tr>
				<?php
				$no++;
				}
