				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select class="form-control required" id="id_kertas" name="id_kertas">
									...
									?>
									<option value="<?php echo $kertas->ID_KERTAS;?>"><?php echo $kertas->NAMA_KERTAS;?></option>
									<?php
									}
									?>
								</select>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="input" class="form-control required " onkeyup="formatRibuan(this)" id="minimal" name="minimal" >
							</div>
							<label class="control-label col-sm-4" for="email">Jumlah Maksimal :</label>
							<div class="col-sm-2">
								<input type="input" class="form-control required " onkeyup="formatRibuan(this)" id="maximal" name="maximal" >
							</div>
						</div>	
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="input" class="form-control required " onkeyup="formatRibuan(this)" id="harga_satu_sisi_member" name="harga_satu_sisi_member" >
							</div>
							<label class="control-label col-sm-3" for="email">Harga Dua Sisi Member :</label>
							<div class="col-sm-3">
								<input type="input" class="form-control required " onkeyup="formatRibuan(this)" id="harga_dua_sisi_member" name="harga_dua_sisi_member" >
							</div>
						</div>	
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="input" class="form-control required " onkeyup="formatRibuan(this)" id="harga_satu_sisi" name="harga_satu_sisi" >
							</div>
							<label class="control-label col-sm-3" for="email">Harga Dua Sisi :</label>
							<div class="col-sm-3">
								<input type="input" class="form-control required " onkeyup="formatRibuan(this)" id="harga_dua_sisi" name="harga_dua_sisi" >
							</div>
						</div>	
