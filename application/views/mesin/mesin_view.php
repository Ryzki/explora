					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='nama_mesin') echo "selected"; ?> value="hp_customer">Berdasarkan Nama Mesin</option>
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_MESIN); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->NAMA_MESIN,base_url().$this->uri->segment(1)."/delete/".$showData->ID_MESIN); 
						?>	
					</td>
					<td align="center"><?php echo $no; ?>.</td>
					<td ><?php echo $showData->NAMA_MESIN; ?></td>
					<td ><?php echo $showData->KET_MESIN; ?></td>
				</tr>
				<?php
				$no++;
				}
