						...
						<div id="a3" class="tab-pane fade in active">
							...
							<form class="form-horizontal" id="form_8" style="display:none">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										<input type="text" readonly class="form-control" id="page_img"  onkeyup="hitung_jumlah_klik()" name="page_img">
									</div>
									...
									<div class="col-sm-2">
										<input type="text" class="form-control"  onkeyup="hitung_jumlah_klik()" id="jml_copy"  name="jml_copy">
									</div>
								</div>
							...
							<form class="form-horizontal" id="form_10" style="display:none">
								...
								<div class="form-group">
									<label class="control-label col-sm-2" for="email">UP :</label>
									<div class="col-sm-2">
										<select class="form-control" onchange="hitung_jumlah_klik_kartu_nama()" id="up_kartu_nama"  name="up_kartu_nama">
											<option value="1">1</option>
									...
									<label class="control-label col-sm-2" for="email">Page on Sheet Side :</label>
									<div class="col-sm-2">
										<select class="form-control" id="page_on_site_side_kartu_nama" onchange="hitung_jumlah_klik_kartu_nama()" name="page_on_site_side_kartu_nama">
											<option value="-">-</option>
										</select>
									</div>
									<label class="control-label col-sm-2" for="email">Klik :</label>
							...
							<form class="form-horizontal" id="form_16" style="display:none">
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<p id="" onclick="SavePath()">File Harus .pdf</p>
					...
					<form id="form_standar">
						...
						<input type="hidden" name="NO_ORDER" value="<?php echo $this->oldData->NO_ORDER; ?>">
							...
							<table class="table table-striped table-bordered">
								...
								<?php
								if($this->uri->segment(1)== 'tambah_barang_print'){
									foreach($this->dataBarangLama  as $barang){
										echo "<tr><td colspan='2'>". $this->text_barang->getText($barang->ID_ORDER,$barang->COUNT_BARANG)."</td></tr>";
									}
								}
								?>
								</tbody>
