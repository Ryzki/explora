      ...
      <div class="box">
					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								...
								<option <?php if($this->input->get('field')=='no_wo') echo "selected"; ?> value="no_wo">Berdasarkan No WO</option>
							</select>
						</div>
						<div class="col-sm-6">							
        ...
        <table class="table table-bordered">
            ...
            <tbody>
				...
				?>
				<tr <?php echo ($showData->LOG_MEMBER != 'Y' ? 'style="background:#e4ffe2"' : ''); ?>>
					...
					<td align="center">
						...
						//echo $this->IdNonMemberBolehProses->id_order;
							if($showData->LOG_MEMBER == 'N'){
								if($this->IdNonMemberBolehProses->id_order == $showData->ID_ORDER ){
							?>
							<a href="<?=base_url();?><?php echo $this->uri->segment('1');?>/proses/<?php echo $showData->ID_ORDER; ?>"><span class="btn btn-success btn-sm">Proses</span>
							<?php
								}
								else{
									echo "Harus Sesuai Antrian Order";
								}
							}
							else{
							?>
					...
					<?php
					if($this->session->userdata('id_kategori_karyawan') != 1){
						echo ($showData->LOG_MEMBER == 'Y' ? $showData->nama_pelanggan : '-');
					}
					else{
						echo $showData->nama_pelanggan;
					}
