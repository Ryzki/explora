...
class Printing extends CI_Controller {
	...
	public function index(){		
		...
		$where  = array('t_order.POSISI_ORDER' => 'OP-PRINT');
		...
		$this->template_view->load_view('printing/printing_view');
	}
	...
	public function proses_data(){
			...
			$status = array('status' => true ,'redirect_link' => base_url()."printing",'pesan_modal' => '<h3>Work Order berhasil disimpan dengan Nomor Wo :  '.$noWO.'</h3><br>WO sekarang sudah berada di Kasir untuk Proses pembayaran.','print_job' => true);
